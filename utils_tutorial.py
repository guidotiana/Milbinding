...
def Get_latent_pocket(pdb_pocket, net_r_pocket, device="cpu"):
    ...
    my_set_for_filter_pocket=np.load("./datasets_and_RFs/filters_names_bins_my_set_for_filter_pock.npy")
    my_filter_pocket=np.load("./datasets_and_RFs/filters_names_bins_my_filter_pock.npy", allow_pickle=True)
...
def Get_encoded_matrix_ligand(latent_vec_ligand, atoms_ligand, num_bins=40):
    ...
    Name_list_ligand=np.load("./datasets_and_RFs/name_ligand.npy")

    Bins_list_old=np.load("./datasets_and_RFs/bins_ligand.npy")
...
def Get_encoded_matrix_pocket(latent_vec_pocket, atoms_pocket, num_bins=40):
    ...
    #Name_list=np.load("../dataset_latent_space_MUV/name_pocket.npy")
    Name_list_pocket=np.load("./datasets_and_RFs/name_pocket.npy")

    Bins_list_old=np.load("./datasets_and_RFs/bins_pocket.npy")
    #Bins_list_ligand_old=np.load("../dataset_latent_space_MUV/bins_ligand.npy")
